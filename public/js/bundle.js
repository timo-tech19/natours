      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " successfully updated"));
            } else {
...
var stripe = Stripe('pk_test_51IGXMPGOW8RjckFUdObARCPMOnLpYyJudRkc71SrlTsNYEm4dYdDR3VwjB8munMFLXjXo5ZrlnIIgHv5CmwDPrUN00lJRIGUNf');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("/api/v1/bookings/checkout-session/".concat(id));
...
var settingBtn = document.querySelector('.btn-data');
...
var bookBtn = document.getElementById('book-btn'); // Add event to login form
...
if (settingBtn) settingBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('name', nameField.value);
  form.append('email', emailField.value);
  form.append('photo', document.getElementById('photo').files[0]);
  (0, _updateSetting.updateSettings)(form, 'user data');
});
if (passwordBtn) passwordBtn.addEventListener('click', /*#__PURE__*/function () {
...
if (bookBtn) bookBtn.addEventListener('click', /*#__PURE__*/function () {
